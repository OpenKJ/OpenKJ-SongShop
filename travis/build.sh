...
BundlePath=$PWD/OpenKJ-SongShop.app
...
osxrelocator ${BundlePath}/Contents/Frameworks/GStreamer.framework/Versions/Current/lib /Library/Frameworks/GStreamer.framework/ /Applications/OpenKJ-SongShop.app/Contents/Frameworks/GStreamer.framework/ -r &>/dev/null
osxrelocator ${BundlePath}/Contents/Frameworks/GStreamer.framework/Versions/Current/libexec /Library/Frameworks/GStreamer.framework/ /Applications/OpenKJ-SongShop.app/Contents/Frameworks/GStreamer.framework -r &>/dev/null
osxrelocator ${BundlePath}/Contents/Frameworks/GStreamer.framework/Versions/Current/bin /Library/Frameworks/GStreamer.framework/ /Applications/OpenKJ-SongShop.app/Contents/Frameworks/GStreamer.framework/ -r &>/dev/null
osxrelocator ${BundlePath}/Contents/MacOS /Library/Frameworks/GStreamer.framework/ /Applications/OpenKJ-SongShop.app/Contents/Frameworks/GStreamer.framework/ -r &>/dev/null

echo "Signing code"
codesign -s "Application: Isaac Lightburn (47W8CPBS5A)" -vvvv --deep --timestamp=none ${BundlePath}
echo "Creating installer"
cp travis/dmgbkg.png ~/
appdmg travis/openkjsongshopdmg.json ${INSTALLERFN} 
