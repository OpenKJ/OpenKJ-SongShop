...
{
    return settings->value("storeDownloadDir", QStandardPaths::writableLocation(QStandardPaths::MusicLocation) + QDir::separator() + "Karaoke_Downloads" + QDir::separator()).toString();
}
    ...
    QObject(parent)
{
    ...
    QCoreApplication::setApplicationName("Song Shop");
